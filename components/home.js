...
export default function Home() {
  ...
  return (
    <section id="home" className="relative">
      <motion.div
        className="h-[150vh] flex flex-col pt-[40vh] justify-start items-center overflow-hidden"
        style={{ scrollYProgress, backgroundColor }}
      >
        <motion.h1
          initial={{ opacity: 0 }}
          animate={{ opacity: 1, transition: { type: "spring" } }}
          className="text-9xl hover:font-bold cursor-pointer mb-5 font-giants"
          style={{ scrollY, scale }}
        >
          Hello, Every One
        </motion.h1>
        <motion.h2
          ...
          className="text-5xl font-light mt-10"
